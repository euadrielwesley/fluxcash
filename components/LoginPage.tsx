  ...
  return (
    <div className="min-h-screen w-full bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 transition-colors relative">
      ...
      <div className="absolute bottom-6 flex flex-col items-center gap-2 animate-fade-in">
         <div className={`px-3 py-1.5 rounded-full border text-[10px] font-bold uppercase tracking-wider flex items-center gap-2 shadow-sm backdrop-blur-md transition-colors ${
            connectionStatus === 'connected' ? 'bg-emerald-50/80 border-emerald-200 text-emerald-700 dark:bg-emerald-900/20 dark:border-emerald-800 dark:text-emerald-400' :
