          ...
          <div className="p-2 space-y-1">
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`w-full flex flex-col md:flex-row items-center md:gap-3 px-2 md:px-4 py-3 rounded-xl transition-all duration-200 ${
...
const IntegrationCard: React.FC<{ service: any }> = ({ service }) => {
  ...
  const [localCreds, setLocalCreds] = useState(config.credentials || {});
